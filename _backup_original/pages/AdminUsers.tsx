                  ...
                  <tr key={profile.id} className="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td className="px-8 py-5">
                      <button 
                        ...
                        className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter border transition-all ${
                    ...
                    <td className="px-8 py-5">
                      <div className={`inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-tighter ${
                        profile.is_approved ? 'text-green-600' : 'text-amber-600'
                      }`}>
