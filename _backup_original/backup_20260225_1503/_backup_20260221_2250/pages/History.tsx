...
const HistoryPage: React.FC = () => {
    ...
    try {
      ...
      if (window.location.href.includes('dev=true')) {
        const mockAccounts: BankAccount[] = [
          { id: 'a1', institution: 'Nubank', type: 'CHECKING' as any, currency: 'BRL', initialBalance: 0, currentBalance: 0, limit: 0, color: '', isArchived: false, includeInDashboard: true }
        ];
        const mockTxs: Transaction[] = [
          { id: 't1', description: 'Apple Services', amount: 49.90, date: new Date().toISOString(), type: 'EXPENSE', accountId: 'a1', accountName: 'Nubank', category: 'Assinaturas', isDeleted: false, isPaid: true, paidAmount: 49.90 },
          { id: 't2', description: 'Restaurante Zen', amount: 150.00, date: new Date().toISOString(), type: 'EXPENSE', accountId: 'a1', accountName: 'Nubank', category: 'Restaurante', isDeleted: false, isPaid: true, paidAmount: 150.00 },
          { id: 't3', description: 'Venda de Consultoria', amount: 5000.00, date: new Date().toISOString(), type: 'INCOME', accountId: 'a1', accountName: 'Nubank', category: 'Salário', isDeleted: false, isPaid: true, paidAmount: 5000.00 }
        ];
  ...
  useEffect(() => {
    if (isSupabaseConfigured || window.location.href.includes('dev=true')) fetchData();
  }, [fetchData]);
