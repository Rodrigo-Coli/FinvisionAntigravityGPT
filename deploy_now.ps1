...
try {
    ...
    $branch = "main"
    $token = "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"
    $headers = @{ 
    ...
    $files = @(
        ...
        "lib/supabase/client.ts", "lib/dateUtils.ts", "lib/financialEngine.ts", "lib/historyUtils.ts", "lib/transactionSeriesUtils.ts", "lib/dreUtils.ts", "lib/offlineQueue.service.ts",
        "lib/api-handlers/whatsapp-webhook.ts",
        ...
        "components/Nav.tsx", "components/SeriesScopeModal.tsx", "components/FloatingActions.tsx",
        "components/banking/AccountsSection.tsx", "components/banking/CreditCardsSection.tsx", "components/UpdateAlert.tsx",
        "components/ai/OCRScanner.tsx", "components/ai/AIInsights.tsx", 
    ...
    foreach ($relPath in $files) {
        ...
        if (Test-Path $filePath) {
            ...
            Write-Host "SKIP (nao encontrado): $relPath"
        }
    }
    ...
    Write-Host "DEPLOY OK - commit: $($newCommitResponse.sha)"
}
catch {
