...
Write-Host "=== FinVision Pro - Deploy Antigravity ===" -ForegroundColor Cyan
...
$commitMessage = "feat: unifica UI mobile com FAB global e corrige responsividade do dashboard

- Criado componente FloatingActions global para mobile
- Removidos botões de ação redundantes dos headers mobile
- Restaurado botão de Adicionar Cartão no desktop
- Corrigida sintaxe JSX no CreditCards.tsx e removido TourGuide inexistente"
