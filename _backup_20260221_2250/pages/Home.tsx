      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex-1 bg-white border border-slate-100 rounded-[24px] p-6 shadow-sm flex flex-col justify-between group cursor-pointer hover:border-brand-200 transition-all">
            ...
            <div>
              <h3 className="text-2xl font-bold text-slate-900 tracking-tight">22.4%</h3>
              <p className="text-[10px] text-slate-400 font-medium">Aumento Mensal</p>
            </div>
          </div>
          ...
          <div className="flex-1 bg-white border border-slate-100 rounded-[24px] p-6 shadow-sm flex flex-col justify-between group cursor-pointer hover:border-brand-200 transition-all">
            ...
            <div>
              <h3 className="text-2xl font-bold text-slate-900 tracking-tight">R$ 8.420</h3>
            ...
            {data.creditCards.map((card, i) => (
              <div key={i} className="bg-white border border-slate-100/80 rounded-[24px] p-5 shadow-sm hover:border-brand-100 transition-all group">
                ...
                <div className="flex items-end justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-[9px] text-slate-400 font-medium italic">de R$ 5.000</p>
                  </div>
                </div>
                <div className="mt-4 h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${Math.min((card.current / 5000) * 100, 100)}%` }}
                  />
                </div>
              </div>
            ))}
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white border border-slate-100 rounded-[32px] p-8 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Seus gastos com alimentação caíram <span className="text-indigo-600 font-bold">15% este mês</span>. Considere alocar o excedente em sua meta de poupança.
              </p>
          ...
          <div className="bg-slate-900 rounded-[32px] p-6 text-white group cursor-pointer overflow-hidden relative">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div>
                <p className="text-[10px] font-black text-white/50 uppercase tracking-widest mb-1">Gasto Total</p>
                <h3 className="text-2xl font-bold tracking-tight">R$ 12.450</h3>
              </div>
