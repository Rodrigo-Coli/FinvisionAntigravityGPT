    ...
    try {
      ...
      if (window.location.href.includes('dev=true')) {
        const mockAccounts: BankAccount[] = [
          { id: 'a1', institution: 'Nubank', name: 'Nubank', type: 'CHECKING' as AccountType, currency: 'BRL', initialBalance: 1000, currentBalance: 125430.20, limit: 0, color: '#9333ea', isArchived: false, includeInDashboard: true },
          { id: 'a2', institution: 'Bradesco', name: 'Bradesco', type: 'CHECKING' as AccountType, currency: 'BRL', initialBalance: 500, currentBalance: 450200.50, limit: 5000, color: '#ef4444', isArchived: false, includeInDashboard: true },
          { id: 'a3', institution: 'XP Investimentos', name: 'XP', type: 'INVESTMENT' as AccountType, currency: 'BRL', initialBalance: 10000, currentBalance: 850000.00, limit: 0, color: '#18181b', isArchived: false, includeInDashboard: true }
        ];
