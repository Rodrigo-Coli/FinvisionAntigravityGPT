...
export default async function handler(req: any, res: any) {
    ...
    try {
        ...
        // ===================================
        // 2. CALCULATE AGGREGATED FINANCIALS
        // ===================================
        ...
        // Monthly income and expense (last 3 months avg)
        let totalIncome3m = 0;
        ...
        // Total monthly installments (amortization payments)
        ...
        // Format data summaries for the prompt
        ...
        // =====================================
        // 3. BUILD THE FINVISION ADVISOR PROMPT
        // =====================================
...
5. **💡 Oportunidades Identificadas** (incluindo: vale vender consórcio no mercado secundário? Vale antecipar parcelas? Comprar imóvel para renda?)`;
        ...
        // Use the standard SDK text accessor
