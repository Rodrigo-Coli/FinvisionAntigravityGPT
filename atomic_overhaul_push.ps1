...
$token = "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" # Token original do Rodrigo-Coli validado nos logs
$headers = @{ 
...
# 3. Criar Tree
Write-Host "Criando arvore atomica..."
...
# 4. Criar Commit
$commitMsg = "feat: liabilities page overhaul - payment ledger, archiving, safety checks, interactive recalculations & a11y"
...
Write-Host "--- SUCESSO! ATUALIZACAO ATOMICA CONCLUIDA ---"
